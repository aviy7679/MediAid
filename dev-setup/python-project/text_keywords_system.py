...
class KeywordTextAnalyzer:
    ...
    def _find_phrase_matches(self, text: str) -> List[Dict]:
        ...
        # Intensity modifiers
        intensifiers = {
            "severe": 1.2, "intense": 1.2, "extreme": 1.3, "terrible": 1.2,
            "mild": 0.8, "slight": 0.7, "minor": 0.7,
            "chronic": 1.1, "persistent": 1.1, "constant": 1.1,
            "acute": 1.2, "sharp": 1.1, "dull": 0.9
        }
            ...
            if body_part in text:
                ...
                for pain_word in pain_indicators:
                    if pain_word in text:
                        ...
                        # Check proximity (within 40 characters)
                        if abs(body_pos - pain_pos) <= 40:
    ...
    def _check_negation(self, text: str, start: int, end: int) -> bool:
        ...
        # Check 20 characters before the symptom
    ...
    def _clean_and_enhance(self, symptoms: List[Dict], original_text: str) -> List[Dict]:
        ...
        for symptom in sorted_symptoms:
            ...
            symptom.update({
                "type_ids": ["T184"],  # Sign or Symptom in UMLS
